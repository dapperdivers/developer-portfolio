...
function parseImports(content, filePath) {
  ...
  [...content.matchAll(IMPORT_PATTERNS.defaultImport)].forEach(match => {
  ...
  [...content.matchAll(IMPORT_PATTERNS.destructuredImport)].forEach(match => {
  ...
  [...content.matchAll(IMPORT_PATTERNS.namespaceImport)].forEach(match => {
    const [_, importName, importPath] = match;
    imports.push(importPath);
  ...
  [...content.matchAll(IMPORT_PATTERNS.dynamicImport)].forEach(match => {
