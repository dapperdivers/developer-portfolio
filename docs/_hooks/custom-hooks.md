---
layout: page
title: "Custom Hooks Documentation"
description: "Comprehensive guide to custom React hooks and their usage patterns"
category: "Hooks"
order: 1
---
...
function ProjectCard({ image }) {
  ...
  return (
    <div style={% raw %}{{ backgroundColor: dominantColor }}{% endraw %}>
      <img 
        ref={colorRef}
        src={image} 
